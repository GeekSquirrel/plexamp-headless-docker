...
## setup nodejs 16.x source, using official script(https://deb.nodesource.com/setup_16.x) with the deprecation warning removed.
setup

## install libraries required by plexamp
apt update && apt upgrade -y
apt install -q -y jq wget curl bzip2 nodejs alsa
